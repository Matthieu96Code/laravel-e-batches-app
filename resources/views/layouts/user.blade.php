            ...
            <nav class="w-full bg-skin-primary grid grid-cols-2 fixed top-0 shadow-md
                ...
                md:flex-col md:items-start md:order-none md:overflow-visible md:border-none md:bg-skin-primary">
                    ...
                    <li className="sidebar-items">
                        <AiOutlineFolderAdd className="sidebar-icons"/>
                        <Link className="text-nowrap" href={{ url('/profile/client/batches/add') }}>Ajouter un lot</Link>
                    </li>
                    <li className="sidebar-items">
                        <MdBatchPrediction className="sidebar-icons"/>
                        <Link className="text-nowrap" href={{ url('/profile/client/batches') }}>Liste de lots</Link>
                    </li>
                    <li class="sidebar-items">
